...
const CommunityConnect = ({setCommunity}) => {
        ...
        <div className="relative">
            <div className="absolute inset-0 flex items-start justify-center" onMouseLeave={() => setCommunity(false)}>
                <div className="border-l border-b w-[22%] h-[264px] pl-4 pt-4 bg-white">
                    ...
                    <p className="w-[80%]">Engage with industry professionals, join discussions, and expand your
                        professional network within the Job Bazaar community.</p>
                    <button
