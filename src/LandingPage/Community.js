...
const Community = ({setCommunity})=>{
    ...
    return(
        <div className="fixed inset-0 flex items-start justify-center z-50 mt-24 bg-inherit bg-white" onMouseLeave={()=> setCommunity(false)}>
            ...
            <button className="border border-gray-900 mt-8  ml-10 p-2.5 rounded-md hover:bg-blue-600 text-[#20262e]" onClick={()=>navigate('/accounts/login')}>Start using Job Bazaar</button>
            </div>
