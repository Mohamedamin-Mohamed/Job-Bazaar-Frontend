        ...
        <>
            ...
            <div className="flex justify-center items-center flex-col h-screen">
                ...
                <div className="flex flex-col justify-center items-center mt-4">
                    <p>- Or -</p>
                    <button className="flex justify-center text-[#367c2b] font-medium mr-12 w-48 mb-8 bg-white border border-[#367c2b] ml-16 mt-4 pl-3 py-1 hover:bg-[#367c2b] hover:text-white">Skip
                        And Browse Jobs
                    </button>
                </div>
            </div>
