          ...
          <div className="flex justify-center items-center mt-8">
              <div className="flex flex-col justify-center pl-4 md:w-[840px] mx-2 w-[450px] h-[460px] border mb-10">
                  <div className="flex ml-2">
                      ...
                      <h1 className="font-semibold text-xl ml-2 mb-1">Job alerts you created</h1>
                  </div>
                  ...
                  <div className="flex flex-col justify-center items-center">
                      ...
                      <button className="text-[#367c2b] bg-[#e6f0e1] border px-3 py-2 font-semibold rounded hover:bg-[#367c2b] hover:text-white" onClick={handleNavigation}>Search Jobs</button>
                  </div>
              </div>
      </div>
    )
