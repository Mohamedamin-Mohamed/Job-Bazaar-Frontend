    ...
    return(
        ...
        <div className="flex flex-col justify-center mx-2 pl-4 md:w-[840px] w-[450px] h-[300px] border">
            ...
            <div className="flex">
                ...
                <div className="flex justify-center items-center bg-[#ffde00] w-[72px] h-[36px] text-center font-semibold mr-6 mt-2 cursor-pointer ml-auto" onClick={()=> setToggle(!toggle)}>
                    {text}
                    <MdKeyboardArrowUp size={25}/>
                </div>
                {toggle && (
                    <div className="absolute md:ml-[726px] md:top-[494px] top-[542px] ml-[209px] flex flex-col justify-start mt-[224px] border w-[200px] h-[90px] p-2 bg-white" ref={ref}>
