...
const AddRole = ({open, handleOpen}) => {
    ...
    return (
        <div
            ...
            <div className="flex flex-col p-7 text-black bg-white w-[520px] border h-[480px] ease-in-out duration-500"
                ref={ref}>
                <div className="flex">
                    <div>
                ...
                <div
                    ...
                    {searchRoles !== '' &&
                        <VscClose size={24} className="ml-auto mt-0.5 mr-3 cursor-pointer" color="gray"
