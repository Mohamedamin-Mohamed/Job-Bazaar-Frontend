    ...
    return (
        <div
            ...
            <div className="flex">
                ...
                <p className="ml-4 mb-4 text-black font-semibold hover:underline hover:cursor-pointer">Update your
                    Profile</p>
            </div>
            ...
            <div className="flex mb-4 ">
                <div
                    className="md:w-[500px] w-[130px] h-[6px] bg-[#e6f0e1] rounded-md mr-1 border border-green-700"></div>
