    ...
    return (
        <div className="flex flex-col justify-center items-center mt-12">
            ...
            <div className="flex flex-col items-center mt-8">
                ...
                <p className="my-3 text-[#4f5666] font-semibold">Sorry, this page is for applicants.</p>
                <div className="flex text-[#2575a7] space-x-8">
                    <NavLink to="mailto:mohamedamin204080@gmail.com"
                        ...
                        Support</NavLink>
                    <NavLink to="/careerhub/my/jobs/uploaded"
                             className="bg-[#2575a7] text-white w-[220px] h-[32px] font-semibold text-center pt-1">View Your Uploaded Jobs</NavLink>
                </div>
            </div>
        </div>
    )
}
export default Display404Employer