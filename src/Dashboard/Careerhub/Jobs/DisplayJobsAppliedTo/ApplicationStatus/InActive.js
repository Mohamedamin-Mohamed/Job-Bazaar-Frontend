                            ...
                            >
                                ...
                                {mediaQuery && (
                                    <div className="flex space-x-8 justify-end w-full mr-12">
                                        <div className="flex space-x-32">
                                            ...
                                            <div>
                                                <p className="mr-14 text-[#a31b12] bg-[#ffefee] font-semibold px-1 w-[82px] overflow-hidden text-ellipsis whitespace-nowrap"
                                ...
                                {!mediaQuery && (
                                    <div className={`flex flex-col justify-center items-center w-[36px] h-[36px]
                                        ...
                                        {showOptions[index] && (
                                            <div
                                                className="absolute flex-col w-[180px] border rounded-md bg-white text-white mt-24 mr-36"
                                                ref={ref}>
                                                <button className="bg-[#0875e1] w-full p-2 mt-2"
